...
while index < len(df_bc):
    bit_max.append(df_bc.iloc[index, 2])
    bit_min.append(df_bc.iloc[index, 3])
    index +=1
b_max = np.max(bit_max)
b_min = np.min(bit_max)
print(b_max)
print(b_min)
index = 0
while index < len(df_bc):
...
while index < len(df_eth):
    eth_max.append(df_eth.iloc[index, 2])
    eth_min.append(df_eth.iloc[index, 3])
    index +=1
e_max = np.max(eth_max)
e_min = np.min(eth_min)
print("eth max", e_max)
print("eth min", e_min)
index = 0
while index < len(df_eth):
